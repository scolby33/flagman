...
latex_documents = [
    (master_doc, 'flagman.tex', 'flagman Documentation',
     'Scott Colby', 'manual'),
]
...
man_pages = [
    (master_doc, 'flagman', 'flagman Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'flagman', 'flagman Documentation',
     author, 'flagman', 'One line description of project.',
     'Miscellaneous'),
]
